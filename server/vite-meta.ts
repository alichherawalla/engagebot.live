...
export async function setupViteWithMeta(app: Express, server: Server) {
  const serverOptions = {
    middlewareMode: true,
    hmr: { server },
...
export function serveStaticWithMeta(app: Express) {
  ...
  app.use("*", async (req, res) => {
    try {
      ...
      console.error('Error serving static with meta:', error);
