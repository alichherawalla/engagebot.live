...
const allStudies = [
  ...
  { id: 4, slug: "legal-services", industry: "Legal Services", challenge: "Needed to build trust and demonstrate expertise to attract startup founders as clients", solution: "Engaged in startup ecosystem conversations and provided valuable legal insights using AI-drafted replies", results: { followers: { before: 1800, after: 5600 }, engagement: { before: "2.1%", after: "6.4%" }, leads: "156 legal consultations", timeframe: "7 months" } },
